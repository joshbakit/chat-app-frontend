...
import { MessageSquare, User, Mail, Lock, Eye, EyeOff, LoaderCircle } from 'lucide-react'
      ...
      <div className='flex flex-col justify-center items-center p-6 sm:p-12 '>
        <div className="w-full max-w-md space-y-8 p-4 bg-green-300 rounded-lg">
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <button typeof='button' className='w-full btn btn-accent' disabled={isSigningUp}>
